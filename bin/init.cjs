...
(async () => {
  ...
  const ZIP_URL =
    "https://github.com/jakguru/ts-lib-starter/archive/refs/heads/main.zip";
  const TMP_DIR = os.tmpdir();
  const ZIP_FILE = path.join(TMP_DIR, "ts-lib-starter.zip");
  const EXTRACT_DIR = path.join(TMP_DIR, "ts-lib-starter-main");
